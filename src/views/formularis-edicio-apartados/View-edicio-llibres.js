...
function ViewEdicioLlibres() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (inputAux.value !== "") {
            ...
            await updateOneDocOfTpo('llibres',idCard,dataQuisom);
            ...
            <div className="row featurette">
                <div className="col-md-12">
                    <div className="card border-info mb-3">
                        <div className="card-header bg-warning"><h2 className="card-title">Llibres</h2></div>
...
export default ViewEdicioLlibres;