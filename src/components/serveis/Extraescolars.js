import imagen1 from "./images/LogoRobotica.PNG";
        ...
        <>
            ...
            <div className="album py-5 bg-light">
                ...
                <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    <div className="col">
                    <div className="card shadow-sm">
                        <svg claclassNamess="bd-placeholder-img card-img-top" width="100%" height="225" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Placeholder: Thumbnail" preserveAspectRatio="xMidYMid slice" focusable="false"><title>Placeholder</title><rect width="100%" height="100%" fill="#55595c"></rect><text x="50%" y="50%" fill="#eceeef" dy=".3em">Thumbnail</text></svg>
                    ...
                    <div className="card shadow-sm">
                        <div className="container container-background">
                            ...
                            <div className="row row-cols-3 col-row-subtitle">
                                <div className=" col-sm-4 col-md-4">1r a 6e</div>
                                <div className=" col-sm-4 col-md-4">280</div>
                                <div className=" col-sm-4 col-md-4">1 dia setmanal</div>
                            </div>
                        </div>
                        <div className="card-body">
                            <p className="card-text">Introducció a la robòtica, investigació del funcionament de màquines, mecanismes i programació utilitzant els primers sensors.</p>
